...
public class SongAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Typeface tf = Typeface.createFromAsset(
				songInf.getContext().getAssets(), fontPath);
		songView.setTypeface(tf);
		artistView.setTypeface(tf);

		// get song using position
		MainActivity.currSong = songs.get(position);
		// get title and artist strings
		songView.setText(MainActivity.currSong.getTitle());
		artistView.setText(MainActivity.currSong.getArtist());
		// set position as tag
